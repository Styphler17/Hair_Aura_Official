...
- [ ] `db_connect.php` created in `public_html/api/` with correct credentials.
- [ ] API endpoints (like `get_products.php`) created to run SQL queries.
- [ ] React Services updated to `fetch()` from these PHP files.
